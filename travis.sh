...
./b2 -j 4 link=shared headers log_setup log date_time timer thread system program_options filesystem regex chrono 
./b2 -j 4 link=shared --with-log --with-thread --with-timer --with-program_options --with-iostreams
cd ..
